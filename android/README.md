...
The published v0.3.8 package is `global.bert.widget` (`versionCode` 12), requires Android 8.0 or newer, and is distributed from [berthalla.io/widget](https://berthalla.io/widget/).
